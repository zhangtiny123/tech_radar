...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
  ...
  if (l) {
    ...
    if (n.width > h) {
      ...
      if (isNaN(r)) {
        if (0 == k)for (p = 1; p < n; p++)r = Math.round(b.length / n * p), b = b.substr(0, r) + m + b.substr(r);
...
AmCharts.parseDefs = function (a, b) {
  for (var c in a) {
    ...
    if (0 < a[c].length && "object" == d)for (d = 0; d < a[c].length; d++) {
      var e = document.createElementNS(AmCharts.SVG_NS, c);
      b.appendChild(e);
      AmCharts.parseDefs(a[c][d], e)
    } else"object" == d ? (e = document.createElementNS(AmCharts.SVG_NS, c), b.appendChild(e), AmCharts.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
  }
};
AmCharts.AxisBase = AmCharts.Class({
  construct: function (a) {
    ...
    var b = a.graphics.getBBox(),
      c = b.x + b.width / 2, b = b.y + b.height / 2, d = a.fillColor;
...
AmCharts.ValueAxis = AmCharts.Class({
  inherits: AmCharts.AxisBase, construct: function (a) {
    ...
    if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)c = !0; else {
      ...
      this.exponential = !1;
      for (f = p; f <
      r; f += n)u = AmCharts.roundTo(this.step * f + this.min, t), -1 != String(u).indexOf("e") && (this.exponential = !0, String(u).split("e"));
      this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
      var t = this.step, H, u = this.minorGridAlpha;
      this.minorGridEnabled && (H = this.getMinorGridStep(t, this.stepWidth * t));
      for (f = p; f < r; f += n)if (p = t * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)if (isNaN(z) || Number(AmCharts.toFixed(p,
          z)) == p) {
        ...
        if (!isNaN(H) && 0 < u && f < r - 1) {
          x = this.gridAlpha;
          this.gridAlpha = this.minorGridAlpha;
          for (e = 1; e < t / H; e++)w = this.getCoordinate(p + H * e), w = new this.axisItemRenderer(this, w, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(w);
          this.gridAlpha = x
        }
      }
      q = this.baseValue;
    ...
    if (r && ("regular" == b || "100%" == b))for (n = 0; n < h.length; n++)m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (k && (m.stackGraph = k), k = m));
    for (k = this.start; k <= this.end; k++) {
      var q = 0;
      for (n = 0; n < h.length; n++)if (m = h[n], m.hidden)m.newStack && (e[k] = NaN, d[k] = NaN); else if (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable)if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g))m.newStack && (e[k] = NaN, d[k] =
        NaN); else {
        ...
        t = m.fillToGraph;
        r && t && (t = this.data[k].axes[this.id].graphs[t.id]) && (l.values.open = t.values.value);
    ...
    for (k = this.start; k <= this.end; k++)for (n = 0; n < h.length; n++)(m = h[n], m.hidden) ? m.newStack && (e[k] = NaN, d[k] = NaN) : (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = g / f[k] * 100, l.values.percents = c, l.values.total = f[k], m.newStack &&
    ...
    for (b = this.start; b <= this.end; b++) {
      ...
      for (d in c)if (c.hasOwnProperty(d)) {
        ...
        if (e.includeInMinMax && (!e.hidden || this.includeHidden)) {
          ...
          var f;
          if (this.minMaxField)f =
            e[this.minMaxField], f > a && (a = f); else for (var g in e)e.hasOwnProperty(g) && "percents" != g && "total" != g && (f = e[g], f > a && (a = f))
        }
      }
    }
    return a
...
AmCharts.RecItem = AmCharts.Class({
  construct: function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    this.set = x;
    var u = a.axisThickness, w = a.axisColor, y = a.axisAlpha, A = a.tickLength, C = a.gridAlpha, B = a.gridThickness, H = a.gridColor, D = a.dashLength, I = a.fillColor, X = a.fillAlpha, ca = a.labelsEnabled;
    m = a.labelRotation;
    ...
    "V" == Oa && (m = 0);
    var W;
    ca && (W = a.autoWrap && 0 === m ? AmCharts.wrappedText(z, c, t, r, q, ha, h, e, 0) : AmCharts.text(z, c, t, r, q, ha, h), ha = W.getBBox(), da = ha.width, Pa = ha.height);
    if ("H" == Oa) {
      ...
      v += q / 2;
      "right" == Z ? (G += pa + ra + aa, v += ia, S ? (f || (v -= q / 2 + 3), G = G - (A + 4) - ma) : (G += A + 4 + u, v -= 2, G += ma)) : S ? (G += A + 4 - aa, f || (v -=
        q / 2 + 3), g && (G += pa, v += ia), G += ma) : (G += -A - u - 4 - 2 - aa, v -= 2, G -= ma);
      ba && ("right" == Z ? (ja += pa + aa + ra, U += ia, ja = S ? ja - u : ja + u) : (ja -= aa, S || (ja -= A + u)));
      f && (v += f);
      S = -3;
      "right" == Z && (S += ia);
...
AmCharts.RecFill = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    "V" == g ? (g = AmCharts.rect(k, a.viW, c, m, l), g.translate(e, b - h + f)) : (g = AmCharts.rect(k,
      c, a.viH, m, l), g.translate(b - h + e, f));
...
AmCharts.AmChart = AmCharts.Class({
  construct: function (a) {
    ...
    if (a =
      ...
      k && AmCharts.AmExport && !this.AmExport &&
      (this.AmExport = new AmCharts.AmExport(this, k));
    ...
    (a = this.container) ? (a.container.innerHTML = "", a.width = this.realWidth, a.height = this.realHeight,
      a.addDefs(this), this.chartDiv.appendChild(a.container)) : a = new AmCharts.AmDraw(this.chartDiv, this.realWidth, this.realHeight, this);
    a.chart = this;
    ...
    if (a) {
      var b =
        this.chartDiv, c = a.offsetWidth, d = a.offsetHeight, e = this.container;
    ...
    a = {x: a, y: b, text: c, align: d, size: e, color: f, alpha: h, rotation: g, bold: k, url: l, enabled: !0};
    ...
    if (0 < b.length) {
      ...
      for (d = 0; d < b.length; d++) {
        var e = b[d];
        !1 !== e.enabled && (c = !1, e = e.size, isNaN(e) && (e = this.fontSize + 2), a += e + 6)
      }
      c && (a = 0)
    }
    return a
    ...
    a = {text: a, size: b, color: c, alpha: d, bold: e, enabled: !0};
    this.titles.push(a);
    return a
  ...
  addListeners: function () {
    ...
    var f = this.balloon;
    f.enabled && (f.followCursor(!1), f.changeColor(b), !c || f.fixedPosition ? (f.setPosition(d, e), f.followCursor(!1)) :
...
AmCharts.AmGraph = AmCharts.Class({
  construct: function (a) {
    ...
    if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) {
      switch (b.type) {
        case "serial":
          a.categoryAxis && (a.createSerialGraph(), "candlestick" == a.type && 1 > a.valueAxis.minMaxMultiplier &&
    ...
    for (f = this.start; f <= this.end; f++) {
      ...
      if (isNaN(h))this.drawLineGraph(b, c), b =
        [], c = []; else {
    ...
    e = "middle";
    f = !1;
    var g = this.labelPosition, h = c.getBBox(),
    ...
    if (c && "serial" == this.chart.type)if (l) {
      if (0 > b || b > this.height)c.remove(), c = !1
    } else if (0 >
      a || a > this.width)c.remove(), c = !1;
    return c
    ...
    var l = this.useNegativeColorIfDown,
      m = this.width, n = this.height, p = this.y, r = this.rotate, q = this.columnCount, t = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), z = this.connect, x = [], u = [], w, y, A, C, B = this.chart.graphs.length, H, D = this.dx / this.tcc, I = this.dy / this.tcc, X = f.stackType, ca = this.start, oa = this.end, S = this.scrollbar, ma = "graph-column-";
    S && (ma = "scrollbar-graph-column-");
    var pa = this.categoryAxis, ia = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, Y = this.lineThickness, T = this.lineAlpha, ra = this.lineColorR, aa = this.dashLength, ba = this.set, sa,
      ha = this.getGradRotation(), O = this.chart.columnSpacing, U = pa.cellWidth, va = (U * h - q) / q;
    O > va && (O = va);
    ...
    if (!(S || "line" != g && "smoothedLine" != g && "step" !=
      g || (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ia && void 0 == Ba || l))) {
      var Qa = Oa;
      Qa > f.max && (Qa = f.max);
      Qa < f.min && (Qa = f.min);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g) {
      if (0 < ca) {
        for (J = ca - 1; -1 < J; J--)if (G = d[J], v = G.axes[f.id].graphs[b], ja = v.values.value, !isNaN(ja)) {
          ca = J;
          break
        }
        if (this.lineColorField)for (J = ca; -1 < J; J--)if (G = d[J], v = G.axes[f.id].graphs[b], v.lineColor) {
          this.bulletColorSwitched =
            this.lineColorSwitched = v.lineColor;
          break
        }
        if (this.fillColorsField)for (J = ca; -1 < J; J--)if (G = d[J], v = G.axes[f.id].graphs[b], v.fillColors) {
          this.fillColorsSwitched = v.fillColors;
          break
        }
        if (this.dashLengthField)for (J = ca; -1 < J; J--)if (G = d[J], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) {
          this.dashLengthSwitched = v.dashLength;
          break
        }
      }
      if (oa < d.length - 1)for (J = oa + 1; J < d.length; J++)if (G = d[J], v = G.axes[f.id].graphs[b], ja = v.values.value, !isNaN(ja)) {
        oa = J;
        break
      }
    }
    ...
    var P = [], Q = [], Ja = !1;
    if ("line" == g || "step" == g ||
      "smoothedLine" == g)if (this.stackable && "regular" == X || "100%" == X || this.fillToGraph)Ja = !0;
    ...
    for (J = ca; J <= oa; J++) {
      ...
      v.index = J;
      var Ya, La = NaN;
      if (l && void 0 == this.openField)for (var tb = J + 1; tb < d.length && (!d[tb] || !(Ya = d[J + 1].axes[f.id].graphs[b]) || !Ya.values || (La = Ya.values.value, isNaN(La))); tb++);
      var R, N, L, ea, ka = NaN, F = NaN, E = NaN, M = NaN, K = NaN, Ma = NaN, Ca = NaN, Na = NaN, Da = NaN, xa = NaN, ya = NaN, fa = NaN, ga = NaN, V = NaN, ub = NaN, vb =
        NaN, la = NaN, na = void 0, Ha = sb, Ra = Va, za = ra, ta, wa, wb = this.proCandlesticks, jb = this.topRadius, Za = this.pattern;
      ...
      if (Aa) {
        ...
        switch (g) {
          case "line":
            if (isNaN(V))z || (this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = []); else {
              if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib)x.push(F), u.push(E), gb = F, hb = E;
              xa = F;
              ya = E;
              fa = F;
              ga = E;
              !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K));
              if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength))this.drawLineGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Ka ? (this.lineColorSwitched =
                ra, this.fillColorsSwitched = sb) : (this.lineColorSwitched = Ba, this.fillColorsSwitched = Ia) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
              v.gap && (this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = [])
            }
            break;
          case "smoothedLine":
            if (isNaN(V))z || (this.drawSmoothedGraph(x, u, P, Q), x = [], u = [], P = [], Q = []); else {
              if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib)x.push(F), u.push(E), gb = F, hb = E;
              xa = F;
              ya = E;
              fa = F;
              ...
              !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K));
              void 0 ==
              v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
              v.gap && (this.drawSmoothedGraph(x, u, P, Q), x = [], u = [], P = [], Q = [])
            }
            break;
          case "step":
            if (!isNaN(V)) {
              r ? (isNaN(w) || (x.push(w), u.push(E - qa)), u.push(E - qa), x.push(F), u.push(E + Ea), x.push(F), !Ja || isNaN(K) || isNaN(M) || (isNaN(A) || (P.push(A), Q.push(K -
              qa)), P.push(M), Q.push(K - qa), P.push(M), Q.push(K + Ea))) : (isNaN(y) || (u.push(y), x.push(w), u.push(y), x.push(F - qa)), x.push(F - qa), u.push(E), x.push(F + Ea), u.push(E), !Ja || isNaN(K) || isNaN(M) || (isNaN(C) || (P.push(M - qa), Q.push(C)), P.push(M - qa), Q.push(K), P.push(M + Ea), Q.push(K)));
              w = F;
              y = E;
              A = M;
              C = K;
              ...
              if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                var Wb = x[x.length - 2], Xb = u[u.length - 2];
                x.pop();
                u.pop();
                this.drawLineGraph(x, u, P, Q);
                x = [Wb];
                u = [Xb];
                P = [];
                Q = [];
              ...
              if (Jb || v.gap)w = y = NaN, this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = []
            } else if (!z) {
            ...
            if (!isNaN(V)) {
              ...
              if (!(V < Kb && la < Kb || V > Lb && la > Lb)) {
                ...
                if (r) {
                  ...
                  ea += Yb - R;
                  ea = AmCharts.fitToBounds(ea, -R, m - R + D * Z);
                  N < n && 0 < L && (na = new AmCharts.Cuboid(e, ea, L, D - a.d3x, I - a.d3y, Ha, Ra, Y, ta, T, ha, t, r, aa,
                  ...
                  R < m + Z * D && 0 < L && (this.showOnAxis && (N -= I / 2), na = new AmCharts.Cuboid(e, L, ea, D - a.d3x, I - a.d3y, Ha, Ra, Y, ta, this.lineAlpha,
              ...
              if (na && (wa = na.set, AmCharts.setCN(a, na.set, "graph-" + this.type), AmCharts.setCN(a, na.set, "graph-" + this.id), v.className && AmCharts.setCN(a, na.set, v.className, !0), v.columnGraphics = wa, wa.translate(R, N), this.columnsSet.push(wa), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), !S)) {
                ...
                "3d" == X && (r ? (H = (this.end + 1 - J) * B - c - 1E3 * this.depthCount, xa += D * this.columnIndex, fa += D * this.columnIndex,
                  v.y += D * this.columnIndex) : (H = (B - c) * (J + 1) + 1E3 * this.depthCount, ya += I * this.columnIndex, ga += I * this.columnIndex, v.y += I * this.columnIndex));
          ...
          case "candlestick":
            if (!isNaN(la) && !isNaN(V)) {
              ...
              if (r) {
                if (N = E - h /
                  2, R = M, L = h, N + L > n && (L = n - N), 0 > N && (L += N, N = 0), N < n && 0 < L) {
                  var yb, zb;
                  ...
                  ea = F - M;
                  na = new AmCharts.Cuboid(e, ea, L, D, I, Ha, Va, Y, ta, T, ha, t, r, aa, Za, jb, ma)
                }
              } else if (R = F - h / 2, N = K + Y / 2, L = h, R + L > m && (L = m - R), 0 > R && (L += R, R = 0), ea = E - K, R < m && 0 < L) {
                wb && V >= la && (Ra = 0);
                var na = new AmCharts.Cuboid(e, L, ea, D, I, Ha, Ra, Y, ta, T, ha, t, r, aa, Za, jb, ma), Ab, Bb;
                V > la ? (Ab = [E, Da], Bb = [K, Ca]) : (Ab = [K, Da],
                  Bb = [E, Ca]);
              ...
              na && (wa = na.set, v.columnGraphics = wa, ba.push(wa), wa.translate(R, N - Y / 2), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), Ta && (ba.push(Ta), ba.push($a)), xa = F, ya = E, r ? (ga = E, fa = F, "open" == k && (fa = M),
              "high" == k && (fa = Na), "low" == k && (fa = Ma)) : (ga = E, "open" == k && (ga = K), "high" == k && (ga = Da), "low" == k && (ga = Ca), fa = F), S || (v.x = r ? N + L / 2 : R + L / 2, this.animateColumns(na, J, F, M, E, K), this.addListeners(wa, v)))
            }
            break;
          case "ohlc":
            if (!(isNaN(la) || isNaN(ub) || isNaN(vb) || isNaN(V))) {
              ...
              var lb, mb, nb;
              if (r) {
                var Cb = E - h / 2, Cb = AmCharts.fitToBounds(Cb, 0, n), Nb = AmCharts.fitToBounds(E, 0, n), Db = E + h / 2, Db = AmCharts.fitToBounds(Db, 0, n);
                mb = AmCharts.line(e, [M, M], [Cb, Nb], za, T, Y,
                  aa);
    ...
    if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, u, P,
      Q) : this.drawLineGraph(x, u, P, Q), S || this.launchAnimation();
    ...
    if (1 < a.length) {
      var f =
        e.set, g = e.chart, h = e.container, k = h.set(), l = h.set();
      f.push(l);
      f.push(k);
      ...
      q && (p = q);
      var q = e.fillColorsR, t = e.fillColorsSwitched;
      t && (q = t);
      var z = e.dashLength;
      (t = e.dashLengthSwitched) && (z = t);
      var t = e.negativeLineColor, x = e.negativeFillColors, u = e.negativeFillAlphas, w = e.baseCoord;
      ...
      void 0 === t || e.useNegativeColorIfDown || (n = AmCharts.line(h, a, b, t, r, n, z, !1, !0), AmCharts.setCN(g, n, e.bcn + "stroke"), AmCharts.setCN(g, n, e.bcn + "stroke-negative"), l.push(n));
      if (0 < f || 0 < u)if (n = a.join(";").split(";"), r = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(),
          ...
          n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(h, n, r, q, f, 1, "#000", 0, a), b.pattern(e.pattern), AmCharts.setCN(g, b, e.bcn + "fill"), k.push(b)), x || void 0 !== t)isNaN(u) && (u = f), x || (x = t), h = AmCharts.polygon(h, n, r, x, u, 1, "#000", 0, a), AmCharts.setCN(g, h, e.bcn + "fill"), AmCharts.setCN(g, h, e.bcn + "fill-negative"), h.pattern(e.pattern), l.push(h), l.click(function (a) {
        e.handleGraphEvent(a, "clickGraph")
      }).mouseover(function (a) {
        e.handleGraphEvent(a, "rollOverGraph")
      }).mouseout(function (a) {
    ...
    if (1 < a.length) {
      ...
      e.push(k);
      e.push(h);
      var l = this.lineAlpha, m = this.lineThickness, e = this.dashLength, n = this.fillAlphas, p = this.lineColorR, r = this.fillColorsR, q = this.negativeLineColor, t = this.negativeFillColors, z = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
      u && (p = u);
      (u = this.fillColorsSwitched) && (r = u);
      u = this.negativeLineAlpha;
      isNaN(u) && (u = l);
      l = new AmCharts.Bezier(g, a, b, p, l, m, r, 0, e);
      AmCharts.setCN(f, l, this.bcn + "stroke");
      h.push(l.path);
      void 0 !== q && (m = new AmCharts.Bezier(g, a, b, q, u, m, r, 0, e), AmCharts.setCN(f, m, this.bcn + "stroke"), AmCharts.setCN(f, m, this.bcn + "stroke-negative"), k.push(m.path));
      0 < n && (l = a.join(";").split(";"), p = b.join(";").split(";"), m = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), l = a.concat(c), p = b.concat(d)) : (this.rotate ? (m +=
    ...
    b && (this.rotate ? (b.translate(-1E3, e), c.translate(-1E3, e)) : (b.translate(d,
      -1E3), c.translate(d, -1E3)), b.animate({opacity: 1, translate: d + "," + e}, f, a), c.animate({
      opacity: 1,
      translate: d + "," + e
    }, f, a))
  }, animate: function (a) {
    ...
    void 0 === a && (a = this.lineColorR, 0 === b && (b = this.fillColorsR) && (a = "object" == typeof b ? b[0] :
      b));
    return a
    ...
    if (!isNaN(b) && !isNaN(c)) {
      ...
      if (this.customBullet || a.customBullet)r = this.customBullet, a.customBullet && (r = a.customBullet), r && (p && p.remove(), "function" == typeof r ? (p = new r, p.chart = d, a.bulletConfig && (p.availableSpace = c, p.graph =
        this, p.graphDataItem = a, p.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(e), p = p.set) : (d.path && (r = d.path + r), p = e.set(), e = e.image(r, 0, 0, g, g), p.push(e), this.centerCustomBullets && e.translate(-g / 2, -g / 2)));
      p && ((a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer"), "serial" == d.type && (0 > b - 0 || b - 0 > this.width || c < -g / 2 || c - 0 > this.height) && (p.remove(), p = null), p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p)), a.bx = b, a.by = c, AmCharts.setCN(d,
        p, this.bcn + "bullet"), a.className && AmCharts.setCN(d, p, a.className, !0));
  ...
  hideCustomBullets: function () {
    ...
    if (a) {
      var c =
      {type: "clickGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b};
...
AmCharts.ChartCursor = AmCharts.Class({
  construct: function (a) {
    ...
    d || (d = b.valueAxes[0]);
    a.valueLineAxis = d;
    a.valueLineBalloonEnabled && (d = new AmCharts.AmBalloon, a.vaBalloon = d, AmCharts.copyProperties(c, d), d.animationDuration =
      0, a.rotate || (d.pointerOrientation = "H"));
    ...
    a.prevTX = [];
    a.prevTY = [];
    if (a.valueBalloonsEnabled)for (c = 0; c < b.graphs.length; c++)d = new AmCharts.AmBalloon, d.className = b.graphs[c].id, d.chart = b, AmCharts.copyProperties(b.balloon, d), b.graphs[c].valueBalloon = d;
    ...
    this.valueLineEnabled &&
    (e = this.valueLineAlpha, isNaN(e) || (b = e), b = AmCharts.line(this.container, g, h, this.cursorColor, b, 1), AmCharts.setCN(a, b, "cursor-value-line"), this.vLine = b, this.set.push(b));
    ...
    if (a.mouseIsOver) {
      ...
      -.5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c), this.setPosition()) : this.rolledOver &&
    ...
    this.zooming && (a.hideXScrollbar && (b = NaN), a.hideYScrollbar &&
    (c = NaN), this.updateSelectionSize(b, c));
    this.fireMoved();
    ...
    if (this.fullWidth) {
      var g = 1;
      d.parseDates && !d.equalSpacing && (g = d.minDuration());
      f ? this.extraWidth = c = a * g : (this.extraWidth = b = a * g, this.categoryBalloon.minWidth = b);
      this.line && this.line.remove();
      this.line = AmCharts.rect(this.container, b, c, this.cursorColor, this.cursorAlpha,
        0);
      AmCharts.setCN(e, this.line, "cursor-fill");
    ...
    void 0 === a && (a = !0);
    this.leaveCursor || (this.hideObj(this.set), this.hideObj(this.categoryBalloon), this.hideObj(this.line), this.hideObj(this.vLine), this.hideObj(this.hLine), this.hideObj(this.vaBalloon),
    ...
    if (this.enabled) {
      ...
      var g = c.categoryAxis, h = c.dx, k = c.dy, l = this.x + 1, m = this.y + 1,
        n = this.width, p = this.height, r = this.data[a];
      this.fireMoved();
      if (r) {
        var q = r.x[g.id], t = c.rotate, z = this.stepWidth, x = this.categoryBalloon, u = this.firstTime, w = this.lastTime, y = this.cursorPosition, A = this.zooming, C = this.panning, B = c.graphs;
        if (c.mouseIsOver || A || C || this.forceShow)if (this.forceShow = !1, C) {
          var h = this.panClickPos, c = this.panClickEndTime, A = this.panClickStartTime, H = this.panClickEnd, l = this.panClickStart, e = (t ? h - f : h - e) / z;
          if (!g.parseDates || g.equalSpacing)e = Math.round(e);
          0 !== e && (h = {type: "zoomed", target: this},
            h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > w && (e = w - c), A + e < u && (e = u - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : H + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = H + e, this.fire(h.type, h)))
        } else {
          "start" == y ? q -= g.cellWidth / 2 : "mouse" == y && (c.mouseIsOver ? q = t ? f - 2 : e - 2 : isNaN(this.tempPosition) || (q = this.tempPosition - 2));
          if (t) {
            if (0 > q)if (A)q = 0; else {
              this.hideCursor();
              return
            }
            if (q > p + 1)if (A)q = p + 1; else {
              this.hideCursor();
              return
            }
          } else {
          ...
          if (0 < this.cursorAlpha) {
            var D = this.line;
            t ? (u = 0, w = q + k, d && (w -= g.cellWidth / 2)) : (u = q, w = 0, d && (u -= g.cellWidth / 2));
            z = this.animationDuration;
            0 < z && !this.zooming ? isNaN(this.previousX) ? D.translate(u, w) : (D.translate(this.previousX, this.previousY), D.animate({translate: u + "," + w}, z, "easeOutSine")) : D.translate(u, w);
            this.previousX = u;
            this.previousY = w;
            D.show()
          }
          this.linePos = t ? q + k : q;
          A && (d && D.hide(), t ? this.updateSelectionSize(NaN, q) : this.updateSelectionSize(q, NaN));
          z = !0;
          A && (z = !1);
          this.categoryBalloonEnabled && z ? (this.setBalloonPosition(x, g, q, t), (u = this.categoryBalloonFunction) ? x.showBalloon(u(r.category)) : g.parseDates ? (g = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat, c), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, r.category)), x.showBalloon(g)) : x.showBalloon(AmCharts.fixNewLines(r.category))) : x.hide();
          B && this.bulletsEnabled && this.showBullets();
          if (this.oneBalloonOnly) {
            q = Infinity;
            for (g = 0; g < B.length; g++)u = B[g], u.showBalloon && !u.hidden && u.balloonText &&
            (w = r.axes[u.valueAxis.id].graphs[u.id], x = w.y, isNaN(x) || (t ? Math.abs(e - x) < q && (q = Math.abs(e - x), H = u) : Math.abs(f - x) < q && (q = Math.abs(f - x), H = u)));
            this.mostCloseGraph && (H = this.mostCloseGraph)
          }
          if (a != this.previousIndex || H != this.previousMostCloseGraph)if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
            this.valueBalloons = z = [];
            for (g = 0; g < B.length; g++)if (u = B[g], x = NaN, (!this.oneBalloonOnly || u == H) && u.showBalloon && !u.hidden && u.balloonText &&
              ("step" == u.type && "left" == u.stepDirection && (r = this.data[a + 1]), r)) {
              if (w = r.axes[u.valueAxis.id].graphs[u.id])x = w.y;
              if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length)for (q = a + 1; q < this.data.length; q++)if (d = this.data[q])if (w = d.axes[u.valueAxis.id].graphs[u.id], x = w.y, !isNaN(x))break;
              if (!isNaN(x)) {
                d = w.x;
                k = !0;
                if (t) {
                ...
                k && (k = this.graphBulletSize, D = this.graphBulletAlpha, 1 == k && isNaN(D) || !AmCharts.isModern || !(y = w.bulletGraphics) || (y.getBBox(), y.translate(w.bx,
                  ...
                  w, !0), (d = u.balloonFunction) && (q = d(w, u).toString()), "" !== q && (t ? k.showBalloon(q) : (k.text = q, k.show = !0), z.push({
                  yy: x,
                  balloon: k
                })), !t && k.set && (k.set.hide(), u = k.textDiv) && (u.style.visibility = "hidden"))
              }
            }
            this.avoidBalloonOverlapping && this.arrangeBalloons()
          }
          b ? (h = {type: "changed"}, h.index = a, h.chart = this.chart, h.zooming = A, h.mostCloseGraph = H, h.position = t ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
          this.previousIndex =
            a;
    ...
    d ? (f && ("right" == e ? a.setBounds(k, l + g, k + m + h, l + c + g) : a.setBounds(k, l + g, k + m + h, l + c)), "right" == e ? f ? a.setPosition(k + m + h, l + c + g) : a.setPosition(k + m + h + b, l + c + g) : f ? a.setPosition(k, l + c) : a.setPosition(k - b, l + c)) : "top" == e ? f ? a.setPosition(k + c + h, l + g) : a.setPosition(k + c + h, l + g - b + 1) : f ? a.setPosition(k + c, l + n) :
      a.setPosition(k + c, l + n + b - 1)
    ...
    c ? (e && (a.pointerWidth = 0), "right" == d ? e ? a.setBounds(l, m + h, l + n + k, m + p + h) : a.setBounds(l + n + k + f, m + h, l + n + 1E3, m + p + h) : e ? a.setBounds(l, m, n + l, p + m) : a.setBounds(-1E3, -1E3, l - g - f, m + p + 15)) : (a.maxWidth = n, b.parseDates && (g = 0, a.pointerWidth = 0), "top" == d ? e ? a.setBounds(l + k, m + h, n + k + l, p + m) : a.setBounds(l + k, -1E3, n + k + l, m + h - g - f) : e ? a.setBounds(l,
      m, n + l, p + m - g) : a.setBounds(l, m + p + g + f - 1, l + n, m + p + g + f))
  ...
  handleMouseUp: function () {
    ...
    if (this.zoomable || this.pan || this.drawing) {
      ...
      if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"),
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
  ...
  removeCursors: function () {
    ...
    this.enabled && (this.dragger.stop(), this.multiplier = a, this.position = b, this.updateScrollbarSize(b, this.rotate ? b + this.height / a : b + this.width / a))
  }, destroy: function () {
    this.clear();
    AmCharts.remove(this.set);
...
AmCharts.ChartScrollbar = AmCharts.Class({
  inherits: AmCharts.SimpleChartScrollbar, construct: function (a) {
    ...
    if (a = this.graph) {
      ...
      b || (b = new AmCharts.AmGraph, b.scrollbar = !0, this.unselectedGraph = b, b.negativeBase = a.negativeBase,
    ...
    if (a.enabled) {
      ...
      if (l = a.graph) {
        ...
        for (r = 0; r < c.length; r++) {
          var q = c[r].axes[p.id].graphs[l.id].values, t;
          for (t in q)if (q.hasOwnProperty(t) && "percents" != t && "total" != t) {
            var z = q[t];
            z < f && (f = z);
            z > g && (g = z)
          }
    ...
    if (this.skipEvent)this.skipEvent = !1; else {
      ...
      if (h.parseDates && !h.equalSpacing) {
        if (a = g.lastTime, g = g.firstTime, h.minDuration(), h = Math.round(b / k) + g, b = this.dragging ? h + this.timeDifference : Math.round((b + c) / k) + g, h > b && (h = b), 0 < e && b - h < e && (b = Math.round(h + (b - h) / 2), d = Math.round(e / 2), h = b - d, b += d, d = !0), b > a && (b = a), b - e < h && (h = b - e), h < g && (h = g), h + e > b && (b = h + e), h != this.startTime || b != this.endTime)this.startTime =
          h, this.endTime = b, f.start = h, f.end = b, f.startDate = new Date(h), f.endDate = new Date(b), this.fire(f.type, f)
  ...
  construct: function (a) {
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        ...
        var q = this.horizontalPadding, t = this.verticalPadding, z = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius, w = c.fontFamily, y = this.fontSize;
        ...
        C < g && (C = g);
        C + B > k && (C = k - B);
        var h = y + t, l = C + q, t = this.shadowAlpha, D = this.shadowColor, q = this.borderThickness, I = this.bulletSize, X;
        0 < u || 0 === z ? (0 < t && (a = AmCharts.rect(e, B, w, n, 0, q + 1, D, t, this.cornerRadius), AmCharts.isModern ?
          ...
          f.push(a)), n = AmCharts.polygon(e, r, u, n, this.fillAlpha, q, p, this.borderAlpha));
        this.bg = n;
        f.push(n);
        n.toFront();
...
AmCharts.AmCoordinateChart = AmCharts.Class({
  inherits: AmCharts.AmChart, construct: function (a) {
    ...
    if (e) {
      ...
      for (z = 0; z < e.length; z++) {
        ...
        if (f && (b = h.categoryFunction ? h.categoryFunction(b, y, h) : b instanceof Date ? AmCharts.newDate(b, h.minPeriod) : x ? AmCharts.stringToDate(b, x) : new Date(b), b = AmCharts.resetDateToMin(b,
            n, p, h.firstDayOfWeek), w.category = b, w.time = b.getTime(), isNaN(w.time)))continue;
        ...
        for (C = 0; C < A.length; C++) {
          ...
          for (H = 0; H < a.length; H++) {
            ...
            if (b.valueAxis.id == B) {
              ...
              !b.connect && u && u[D] && w.time - r[D] >= q * I && (u[D].gap = !0);
    ...
    if (1 != a) {
      ...
      var b;
      for (b = 0; b <
      a.length; b++)a[b].changeOpacity(1)
    }
...
AmCharts.AmRectangularChart = AmCharts.Class({
  ...
  removeTrendLine: function (a) {
    ...
    if (a) {
      a.rotate = b;
      var c = this.marginTopReal, d =
        this.marginLeftReal, e = a.scrollbarHeight, f = this.dx, g = this.dy, h = a.offset;
...
AmCharts.TrendLine = AmCharts.Class({
  construct: function (a) {
    ...
    var a = this;
    a.destroy();
    var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, q = a.initialXValue, t = a.finalXValue, z = a.initialValue, x = a.finalValue,
      u = p.recalculateToPercents, w = b.dataDateFormat;
    ...
    r && !u && (isNaN(q) || (d = r.getCoordinate(q)), isNaN(t) || (e = r.getCoordinate(t)));
    p && !u && (isNaN(z) || (f = p.getCoordinate(z)), isNaN(x) || (g = p.getCoordinate(x)));
    isNaN(d) || isNaN(e) ||
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
  var n = a.set();
  for (m = 1; m < b.length; m++)for (var p = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], q = 1; q < p.length; q++)n.push(AmCharts.line(a, [p[q - 1], p[q]], [r[q - 1], r[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
  return n
};
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
  ...
  g = p(g);
  h = p(h);
  var r = p(g / f * h), q = AmCharts.VML, t = 359.5 + f / 100;
  359.94 < t && (t = 359.94);
  e >= t && (e = t);
  var z = 1 / 180 * Math.PI, t = b + Math.sin(d * z) * h, x = c - Math.cos(d * z) * r, u = b + Math.sin(d * z) * f, w = c - Math.cos(d * z) * g, y = b + Math.sin((d + e) * z) * f, A = c - Math.cos((d + e) * z) * g, C = b + Math.sin((d + e) * z) * h, z = c - Math.cos((d + e) * z) * r, B = {
  ...
  d = a.set();
  var D;
  q && (t = p(10 * t), u = p(10 * u), y = p(10 * y), C = p(10 * C), x = p(10 * x), w = p(10 * w), A = p(10 * A), z = p(10 * z), b = p(10 * b), k = p(10 * k), c = p(10 * c), f *= 10, g *= 10, h *= 10, r *= 10, 1 > Math.abs(e) && 1 >= Math.abs(y - u) && 1 >= Math.abs(A - w) && (D = !0));
  e = "";
  var I;
  n && (B["fill-opacity"] = 0, B["stroke-opacity"] = l["stroke-opacity"] / 2, B.stroke = l.stroke);
  0 < k && (I = " M" + t + "," + (x + k) + " L" + u + "," + (w + k), q ? (D || (I += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + u + "," + (w + k) + "," + y + "," + (A + k)), I += " L" + C + "," + (z + k), 0 < h && (D || (I += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) +
  "," + C + "," + (k + z) + "," + t + "," + (k + x)))) : (I += " A" + f + "," + g + ",0," + H + ",1," + y + "," + (A + k) + " L" + C + "," + (z + k), 0 < h && (I += " A" + h + "," + r + ",0," + H + ",0," + t + "," + (x + k))), I = a.path(I + " Z", void 0, void 0, "1000,1000").attr(B), d.push(I), I = a.path(" M" + t + "," + x + " L" + t + "," + (x + k) + " L" + u + "," + (w + k) + " L" + u + "," + w + " L" + t + "," + x + " Z", void 0, void 0, "1000,1000").attr(B), k = a.path(" M" + y + "," + A + " L" + y + "," + (A + k) + " L" + C + "," + (z + k) + " L" + C + "," + z + " L" + y + "," + A + " Z", void 0, void 0, "1000,1000").attr(B), d.push(I), d.push(k));
  q ? (D || (e = " A" + p(b - f) + "," + p(c - g) +
  "," + p(b + f) + "," + p(c + g) + "," + p(u) + "," + p(w) + "," + p(y) + "," + p(A)), f = " M" + p(t) + "," + p(x) + " L" + p(u) + "," + p(w) + e + " L" + p(C) + "," + p(z)) : f = " M" + t + "," + x + " L" + u + "," + w + (" A" + f + "," + g + ",0," + H + ",1," + y + "," + A) + " L" + C + "," + z;
  0 < h && (q ? D || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + C + "," + z + "," + t + "," + x) : f += " A" + h + "," + r + ",0," + H + ",0," + t + "," + x);
  a.handDrawn && (b = AmCharts.line(a, [t, u], [x, w], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l["stroke-opacity"]), d.push(b));
...
AmCharts.AmDraw = AmCharts.Class({
  construct: function (a, b, c, d) {
    ...
    AmCharts.hasSVG ? (AmCharts.SVG = !0, b = this.createSvgElement("svg"), a.appendChild(b), this.container = b, this.addDefs(d), this.R = new AmCharts.SVGRenderer(this)) :
...
AmCharts.AmLegend = AmCharts.Class({
  construct: function (a) {
    ...
    "outside" == b ? (c = f.offsetWidth, e = f.offsetHeight, f.clientHeight && (c = f.clientWidth, e = f.clientHeight)) : (isNaN(c) || (f.style.width =
      c + "px"), f.className = "amChartsLegend " + a.classNamePrefix + "-legend-div");
    this.divWidth = c;
    (b = this.container) ? (b.container.innerHTML = "", f.appendChild(b.container), b.width = c, b.height = e, b.addDefs(a)) : b = new AmCharts.AmDraw(f, c, e, a);
    this.container = b;
    this.lx = 0;
    this.ly = 8;
    e = this.markerSize;
    ...
    this.titleWidth = 0;
    if (e = this.title)e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, e, "legend-title"),
      e.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = e.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
    ...
    var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div,
      h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h - c - b, p = 0, r = 0, q = this.container;
    this.set && this.set.remove();
    var t = q.set();
    this.set = t;
    var z = q.set();
    t.push(z);
    var x = this.entries, u, w;
    ...
    for (w = 0; w < x.length; w++) {
      ...
      u = H.getBBox();
      var D;
      this.equalWidths ? D = f + y * (p + m + this.markerLabelGap) : (D = A, A = A + u.width + f + m);
      u.height > B && (B = u.height);
      D + u.width > n && 0 < w && 0 !== y && (r++, y = 0, D = f, A = D + u.width + f + m, C = C + B + l, B = 0);
      H.translate(D, C);
      y++;
    ...
    c.toBack();
    b = f;
    if ("top" == a || "bottom" == a || "absolute" == a || "outside" ==
      a)"center" == this.align ? b = f + (h - u.width) / 2 : "right" == this.align && (b = f + h - u.width);
    z.translate(b, l + 1);
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      if (this.useGraphSettings) {
        ...
        if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m =
          AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), p = 0, m = l, n = l / 3; else {
          var r;
        ...
        l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
      ...
      (f = this.switchType) && "none" != f && ("x" == f ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == f ? c.hide() : c.show() : "x" != f && c.hide(), this.switchable || c.hide(), this.addListeners(c,
...
AmCharts.stringToDate = function (a, b) {
  var c = {}, d = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {
    ...
    pattern: "JJ",
    period: "hours"
  }, {pattern: "J", period: "hours"}, {pattern: "HH", period: "hours"}, {pattern: "H", period: "hours"}, {
    pattern: "KK",
    period: "hours"
  }, {pattern: "K", period: "hours"}, {pattern: "LL", period: "hours"}, {pattern: "L", period: "hours"}, {
    pattern: "NN",
    period: "minutes"
  }, {
    pattern: "N",
